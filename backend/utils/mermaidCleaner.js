...
/**
 * Pre-cleans all Mermaid blocks in markdown content
 */
export function cleanMermaidInMarkdown(markdownContent) {
  if (!markdownContent) return '';
  return markdownContent.replace(/```mermaid\s*([\s\S]*?)```/gi, (match, code) => {
